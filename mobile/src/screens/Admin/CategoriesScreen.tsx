...
export default function AdminCategoriesScreen({ token, onCreate, onEdit }: Props) {
  ...
  return (
    <View style={styles.container}>
      ...
      <FlatList
        ...
        ListEmptyComponent={loading ? <Text style={styles.muted}>Loading...</Text> : <Text style={styles.muted}>Tidak ada kategori</Text>}
        renderItem={({ item }) => (
